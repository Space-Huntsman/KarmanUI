...
describe('Container', () => {
  ...
  it('direction', done => {
    vm = createVue({
      template: `
        <kui-container :direction="direction">
          <kui-header></kui-header>
          <kui-main></kui-main>
        </kui-container>
      `,
...
describe('Header', () => {
  ...
  it('height', () => {
    vm = createVue({
      template: `
        <kui-header height="100px"></kui-header>
      `
    }, true);
...
describe('Aside', () => {
  ...
  it('width', () => {
    vm = createVue({
      template: `
        <kui-aside width="200px"></kui-aside>
      `
    }, true);
...
describe('Footer', () => {
  ...
  it('height', () => {
    vm = createVue({
      template: `
        <kui-footer height="100px"></kui-footer>
      `
    }, true);
    expect(vm.$children[0].$el.style.height).to.equal('100px');
  });
