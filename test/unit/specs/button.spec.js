...
describe('Button', () => {
  ...
  it('create', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('kui-button--primary')).to.be.true;
  });
  it('icon', () => {
    vm = createTest(Button, {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.querySelector('.kui-icon-search')).to.be.ok;
  });
  it('nativeType', () => {
    vm = createTest(Button, {
      nativeType: 'submit'
  ...
  it('loading', () => {
    ...
    expect(buttonElm.querySelector('.kui-icon-loading')).to.be.ok;
  });
  it('disabled', () => {
    vm = createTest(Button, {
      disabled: true
  ...
  it('size', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('kui-button--medium')).to.be.true;
  });
  it('plain', () => {
    vm = createTest(Button, {
      plain: true
  ...
  it('click', done => {
    ...
    vm = createVue({
      template: `
        <kui-button @click="handleClick"></kui-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
  ...
  it('click inside', done => {
    ...
    vm = createVue({
      template: `
        <kui-button @click="handleClick"><span class="inner-slot"></span></kui-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
  ...
  it('loading implies disabled', done => {
    ...
    vm = createVue({
      template: `
        <kui-button loading @click="handleClick"><span class="inner-slot"></span></kui-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
