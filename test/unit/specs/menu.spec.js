...
describe('Menu', () => {
  ...
  it('create', done => {
    vm = createVue({
      template: `
        <kui-menu>
          <kui-menu-item index="1" ref="item1">处理中心</kui-menu-item>
          <kui-menu-item index="2" ref="item2">订单管理</kui-menu-item>
        </kui-menu>
      `
    }, true);
  ...
  it('menu-item click', done => {
    vm = createVue({
      template: `
        <kui-menu>
          <kui-menu-item @click="onMenuItemClick" index="1" ref="item1">处理中心</kui-menu-item>
          <kui-menu-item index="2" ref="item2">订单管理</kui-menu-item>
        </kui-menu>
      `,
      methods: {
  ...
  it('menu-item disabled', done => {
    vm = createVue({
      template: `
        <kui-menu default-active="2">
          <kui-menu-item index="1" ref="item1" disabled>处理中心</kui-menu-item>
          <kui-menu-item index="2" ref="item2">订单管理</kui-menu-item>
        </kui-menu>
      `
    }, true);
  ...
  describe('default active', () => {
    ...
    it('dynamic active', done => {
      vm = createVue({
        template: `
          <kui-menu :default-active="active">
            <kui-menu-item index="1" ref="item1">active watch处理中心</kui-menu-item>
            <kui-menu-item index="2" ref="item2">active watch订单管理</kui-menu-item>
          </kui-menu>
        `,
        data() {
          return {
    ...
    it('vertical submenu item active', done => {
      vm = createVue({
        template: `
          <div>
            <kui-menu default-active="2-2">
              <kui-menu-item index="1" ref="item1">处理中心</kui-menu-item>
              <kui-submenu index="2" ref="submenu">
                <template slot="title">我的工作台</template>
                <kui-menu-item index="2-1">选项1</kui-menu-item>
                <kui-menu-item index="2-2" ref="submenuItem2">选项2</kui-menu-item>
                <kui-menu-item index="2-3">选项3</kui-menu-item>
              </kui-submenu>
              <kui-menu-item index="3">订单管理</kui-menu-item>
            </kui-menu>
          </div>
        `
      }, true);
  ...
  describe('submenu', function() {
    it('toggle', done => {
      ...
      submenu.$el.querySelector('.kui-submenu__title').click();
      setTimeout(_ => {
    ...
    it('default opened', done => {
      vm = createVue({
        template: `
          <kui-menu :default-openeds="defaultOpeneds">
            <kui-menu-item index="1">default opened处理中心</kui-menu-item>
            <kui-submenu index="2" ref="submenu1">
              <template slot="title">default opened我的工作台</template>
              <kui-menu-item index="2-1">选项1</kui-menu-item>
              <kui-menu-item index="2-2" ref="submenu1Item2">选项2</kui-menu-item>
              <kui-menu-item index="2-3">选项3</kui-menu-item>
            </kui-submenu>
            <kui-submenu index="3" ref="submenu2">
              <template slot="title">default opened订单管理</template>
              <kui-menu-item index="3-1">选项1</kui-menu-item>
              <kui-menu-item index="3-2" ref="submenu2Item2">选项2</kui-menu-item>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <kui-menu>
            <kui-menu-item index="1" ref="item1">处理中心</kui-menu-item>
            <kui-submenu index="2" ref="submenu" disabled>
              <template slot="title">我的工作台</template>
              <kui-menu-item index="2-1">选项1</kui-menu-item>
              <kui-menu-item index="2-2" ref="submenuItem2">选项2</kui-menu-item>
              <kui-menu-item index="2-3">选项3</kui-menu-item>
  ...
  it('unique-opened', done => {
    vm = createVue({
      template: `
        <kui-menu unique-opened default-active="2-2">
    ...
    vm.$refs.submenu2.$el.querySelector('.kui-submenu__title').click();
    setTimeout(_ => {
  ...
  it('horizontal mode', done => {
    ...
    expect(vm.$el.classList.contains('kui-menu--horizontal')).to.be.true;
    var submenu = vm.$refs.submenu;
  ...
  it('menu trigger click', done => {
    vm = createVue({
      template: `
        <kui-menu mode="horizontal" menu-trigger="click">
          <kui-menu-item index="1">处理中心</kui-menu-item>
          <kui-submenu index="2" ref="submenu">
            <template slot="title">我的工作台</template>
            <kui-menu-item index="2-1">选项1</kui-menu-item>
    ...
    expect(vm.$el.classList.contains('kui-menu--horizontal')).to.be.true;
    var submenu = vm.$refs.submenu;
    var triggerElm = submenu.$el.querySelector('.kui-submenu__title');
  ...
  it('menu group', () => {
    vm = createVue({
      template: `
        <kui-menu mode="vertical" default-active="1">
          <kui-menu-item-group title="分组一" ref="group1">
            <kui-menu-item index="1"><i class="kui-icon-message"></i>导航一</kui-menu-item>
            <kui-menu-item index="2"><i class="kui-icon-message"></i>导航二</kui-menu-item>
          </kui-menu-item-group>
          <kui-submenu index="5">
            <template slot="title">导航五</template>
            <kui-menu-item-group title="分组二">
              <kui-menu-item index="5-1">选项1</kui-menu-item>
              <kui-menu-item index="5-2">选项2</kui-menu-item>
            </kui-menu-item-group>
          </kui-submenu>
        </kui-menu>
      `
    }, true);
    expect(vm.$refs.group1.$el.querySelector('.kui-menu-item-group__title').innerText).to.be.equal('分组一');
  });
  it('dynamic menus, issue 9092', done => {
    ...
    setTimeout(_ => {
      ...
      setTimeout(_ => {
        expect(vm.$el.querySelector('.kui-menu-item.is-active').innerText).to.equal('new');
        done();
      }, 20);
    }, 100);
  });
