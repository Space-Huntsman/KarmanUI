...
describe('Slider', () => {
  ...
  it('should not exceed min and max', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" :min="50">
          </kui-slider>
        </div>
      `,
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" :show-tooltip="false">
          </kui-slider>
        </div>
      `,
  ...
  it('format tooltip', async() => {
    vm = createVue({
      template: `
        <div>
          <kui-slider ref="slider" v-model="value" :format-tooltip="formatTooltip">
          </kui-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" :vertical="vertical"></kui-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value"></kui-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <kui-slider v-model="value" :min="0" :max="1" :step="0.1"></kui-slider>
        </div>
      `,
  ...
  it('change event', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" @change="onChange">
          </kui-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" disabled></kui-slider>
        </div>
      `,
  ...
  it('show input', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider v-model="value" show-input></kui-slider>
        </div>
      `,
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.kui-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.kui-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.kui-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <kui-slider vertical v-model="value" height="200px"></kui-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <kui-slider v-model="value" range></kui-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <kui-slider v-model="value" range :min="50">
          </kui-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <kui-slider range v-model="value"></kui-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <kui-slider v-model="value" range :min="min" :max="max">
          </kui-slider>
        </div>
      `,
    ...
    it('marks', async() => {
      ...
      waitImmediate();
      const stops = vm.$el.querySelectorAll('.kui-slider__marks-stop.kui-slider__stop');
      const marks = vm.$el.querySelectorAll('.kui-slider__marks .kui-slider__marks-text');
