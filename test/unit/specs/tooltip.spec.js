...
describe('Tooltip', () => {
  ...
  it('create', done => {
    vm = createVue(`
      <kui-tooltip ref="tooltip" content="提示文字">
        <button>click</button>
      </kui-tooltip>`);
  ...
  it('custom popper class', done => {
    vm = createVue(`
      <kui-tooltip ref="tooltip" content="提示文字" popper-class="custom-popper">
        <button>click</button>
      </kui-tooltip>`);
    vm.$nextTick(_ => {
  ...
  describe('manual', () => {
    const vm = createVue({
      template: `
        <kui-tooltip ref="tooltip" manual content="abc" v-model="show">
          <button>click</button>
        </kui-tooltip>
      `,
  ...
  it('light mode', done => {
    vm = createVue(`
      <kui-tooltip ref="tooltip" content="abc" effect="light">
        <button>abc</button>
      </kui-tooltip>
    `);
    vm.$nextTick(_ => {
  ...
  it('hide after', done => {
    vm = createVue(`
      <kui-tooltip ref="tooltip" content="提示文字" :hide-after="300">
        <button>click</button>
      </kui-tooltip>`);
    const tooltip = vm.$refs.tooltip;
    vm.$nextTick(_ => {
  ...
  it('reference karman focus', done => {
    vm = createVue(`
    <kui-tooltip ref="tooltip" content="提示文字">
      <button>click</button>
    </kui-tooltip>`);
  ...
  it('custom tabindex', () => {
    vm = createVue(`
      <kui-tooltip ref="tooltip" content="提示文字" :tabindex="-1">
        <button>click</button>
      </kui-tooltip>
    `, true);
