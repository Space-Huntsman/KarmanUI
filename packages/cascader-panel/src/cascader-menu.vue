...
export default {
  ...
  methods: {
    ...
    renderNodeList(h) {
      ...
      return [
        ...nodes,
        isHoverMenu ? <svg ref='hoverZone' class='kui-cascader-menu__hover-zone'></svg> : null
      ];
    }
  },
  ...
  render(h) {
    ...
    return (
      <kui-scrollbar
        ...
        role="menu"
        id={ menuId }
        class="kui-cascader-menu"
        wrap-class="kui-cascader-menu__wrap"
        view-class={{
          'kui-cascader-menu__list': true,
          'is-empty': isEmpty
        }}
        { ...events }>
