<script>
  ...
  import KuiRadio from 'karman-ui/packages/radio';
  import { isEqual } from 'karman-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderRadio(h) {
        ...
        return (
          <kui-radio
            ...
            {/* add an empty karman to avoid render label */}
            <span></span>
          </kui-radio>
        );
      },
      ...
      renderCheckIcon(h) {
        return (
          <i class="kui-icon-check kui-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="kui-icon-loading kui-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="kui-icon-arrow-right kui-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="kui-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
