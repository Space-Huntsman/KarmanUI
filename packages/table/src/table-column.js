...
export default {
  ...
  methods: {
    ...
    getColumnKuiIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[Karman Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnKuiIndex(children, this.$el);
