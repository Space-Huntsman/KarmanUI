...
class TableLayout {
  ...
  updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      const body = bodyWrapper.querySelector('.kui-table__body');
  ...
  updateElsHeight() {
    ...
    // fix issue (https://github.com/spaceHuntsman/karman/pull/16956)
    const headerTrElm = headerWrapper ? headerWrapper.querySelector('.kui-table__header tr') : null;
