import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'karman-ui/src/utils/dom';
...
export default {
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="kui-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['kui-icon-arrow-down', column.filterOpened ? 'kui-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
  ...
  mounted() {
    // nextTick 是有必要的 https://github.com/spaceHuntsman/karman/pull/11311
    this.$nextTick(() => {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.kui-table__column-filter-trigger') || cell;
