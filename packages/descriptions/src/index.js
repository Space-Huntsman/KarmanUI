...
import { isFunction } from 'karman-ui/src/utils/types';

export default {
  name: 'KuiDescriptions',
  components: {
  ...
  methods: {
    ...
    getRows() {
      const children = ((this.$slots.default || []).filter(vnode => vnode.tag &&
            vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'KuiDescriptionsItem'));
  ...
  render() {
    ...
    return (
      <div class="kui-descriptions">
        {
          (title || extra || $slots.title || $slots.extra)
            ? <div class="kui-descriptions__header">
              <div class="kui-descriptions__title">
                { $slots.title ? $slots.title : title}
              </div>
              <div class="kui-descriptions__extra">
        ...
        <div class="kui-descriptions__body">
          <table class={[{'is-bordered': border}, descriptionsSize ? `kui-descriptions--${descriptionsSize}` : '']}>
            {rows.map(row => (
