export default {
  ...
  render(h) {
    ...
    if (elDescriptions.direction === 'vertical') {
      return (
        <tbody>
          <tr class="kui-descriptions-row">
            {
              row.map(item => {
                return (
                  <th
                    class={{
                      'kui-descriptions-item__label': true,
          ...
          <tr class="kui-descriptions-row">
            {
              row.map(item =>{
                return (
                  <td
                    class="kui-descriptions-item__content"
                    class={['kui-descriptions-item__content', item.contentClassName]}
        ...
        <tr class="kui-descriptions-row">
          {
            row.map(item=> {
              return (
                <td class="kui-descriptions-item" colSpan={item.props.span}>
                  <div class="kui-descriptions-item__container">
                    <span
                      class={{
                        'kui-descriptions-item__label': true,
