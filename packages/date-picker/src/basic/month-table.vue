<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="kui-month-table">
    <tbody>
...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'karman-ui/src/utils/date-util';
  import { hasClass } from 'karman-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'karman-ui/src/utils/util';
