...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime} from 'karman-ui/src/utils/date-util';
  import Locale from 'karman-ui/src/mixins/locale';
  import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from 'karman-ui/src/utils/util';
  ...
  // remove the first karman that satisfies `pred` from arr
