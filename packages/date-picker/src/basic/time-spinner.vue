<template>
  <div class="kui-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <kui-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="kui-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="kui-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="kui-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="kui-time-spinner__arrow kui-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kui-time-spinner__arrow kui-icon-arrow-down"></i>
        <ul class="kui-time-spinner__list" ref="hours">
          <li
            class="kui-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="kui-time-spinner__arrow kui-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kui-time-spinner__arrow kui-icon-arrow-down"></i>
        <ul class="kui-time-spinner__list" ref="minutes">
          <li
            class="kui-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="kui-time-spinner__arrow kui-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kui-time-spinner__arrow kui-icon-arrow-down"></i>
        <ul class="kui-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'karman-ui/src/utils/date-util';
  import KuiScrollbar from 'karman-ui/packages/scrollbar';
  import RepeatClick from 'karman-ui/src/directives/repeat-click';
