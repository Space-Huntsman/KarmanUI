<template>
  <transition name="kui-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="kui-picker-panel kui-date-range-picker kui-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="kui-picker-panel__body-wrapper">
        <slot name="sidebar" class="kui-picker-panel__sidebar"></slot>
        <div class="kui-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="kui-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="kui-picker-panel__body">
          <div class="kui-date-range-picker__time-header" v-if="showTime">
            <span class="kui-date-range-picker__editors-wrap">
              <span class="kui-date-range-picker__time-picker-wrap">
                <kui-input
                  size="small"
              ...
              <span class="kui-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <kui-input
                  size="small"
                  class="kui-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="kui-icon-arrow-right"></span>
            <span class="kui-date-range-picker__editors-wrap is-right">
              <span class="kui-date-range-picker__time-picker-wrap">
                <kui-input
                  size="small"
                  class="kui-date-range-picker__editor"
              ...
              <span class="kui-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <kui-input
                  size="small"
                  class="kui-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="kui-picker-panel__content kui-date-range-picker__content is-left">
            <div class="kui-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="kui-picker-panel__icon-btn kui-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="kui-picker-panel__icon-btn kui-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="kui-picker-panel__icon-btn kui-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="kui-picker-panel__icon-btn kui-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="kui-picker-panel__content kui-date-range-picker__content is-right">
            <div class="kui-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="kui-picker-panel__footer" v-if="showTime">
        <kui-button
          size="mini"
          type="text"
...
<script type="text/babel">
  import {
    ...
    extractDateFormat,
    extractTimeFormat
  } from 'karman-ui/src/utils/date-util';
  ...
  export default {
    ...
    methods: {
      ...
      handleRangePick(val, close = true) {
        ...
        // workaround for https://github.com/spaceHuntsman/karman/issues/7539, should remove this block when we don't have to care about Chromium 55 - 57
        setTimeout(() => {
          this.maxDate = maxDate;
          this.minDate = minDate;
        }, 10);
    ...
    components: { TimePicker, DateTable, KuiInput, KuiButton }
  };
</script>
