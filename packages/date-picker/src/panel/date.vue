<template>
  <transition name="kui-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="kui-picker-panel kui-date-picker kui-popper"
      :class="[{
      ...
      <div class="kui-picker-panel__body-wrapper">
        ...
        <div class="kui-picker-panel__body">
          <div class="kui-date-picker__time-header" v-if="showTime">
            ...
            <span class="kui-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <kui-input
                ref="input"
          ...
          <div
            class="kui-date-picker__header"
            :class="{ 'kui-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            ...
            <span
              ...
              role="button"
              class="kui-date-picker__header-label">{{ yearLabel }}</span>
            <span
          ...
          <div class="kui-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
      ...
      <div
        class="kui-picker-panel__footer"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, KuiInput, KuiButton
    },
