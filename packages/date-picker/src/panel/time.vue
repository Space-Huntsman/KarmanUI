<template>
  <transition name="kui-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="kui-time-panel kui-popper"
      :class="popperClass">
      <div class="kui-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <div class="kui-time-panel__footer">
        <button
          type="button"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'karman-ui/src/utils/date-util';
