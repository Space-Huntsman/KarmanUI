...
import KuiSelect from 'karman-ui/packages/select';
import KuiOption from 'karman-ui/packages/option';
import KuiInput from 'karman-ui/packages/input';
import Locale from 'karman-ui/src/mixins/locale';
import { valueEquals } from 'karman-ui/src/utils/util';
...
export default {
  ...
  render(h) {
    ...
    let template = <div class={['kui-pagination', {
      'is-background': this.background,
      'kui-pagination--small': this.small
    }] }></div>;
    const TEMPLATE_MAP = {
      prev: <prev></prev>,
    ...
    const rightWrapper = <div class="kui-pagination__rightwrapper"></div>;
  ...
  components: {
          ...
          <button
            ...
            on-click={ this.$parent.prev }>
            {
              this.$parent.prevText
                ...
                : <i class="kui-icon kui-icon-arrow-left"></i>
            }
          </button>
        );
      }
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class="kui-pagination__sizes">
            <kui-select
    ...
    Jumper: {
      ...
      methods: {
        handleKeyup({ keyCode, target }) {
          ...
          // Hack for IE: https://github.com/spaceHuntsman/karman/issues/11710
