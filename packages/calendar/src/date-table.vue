...
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'karman-ui/src/utils/date-util';
        ...
        <tbody>
          {
            this.rows.map((row, index) => <tr
              class={{
                'kui-calendar-table__row': true,
                'kui-calendar-table__row--hide-border': index === 0 && this.hideHeader
              }}
              key={index}>
              {
