  ...
  <div
    ...
    <span
      ...
      <i
        ...
        class="kui-rate__icon"
        :style="getIconStyle(item)">
        <i
          v-if="showDecimalIcon(item)"
          :class="decimalIconClass"
          :style="decimalStyle"
          class="kui-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="kui-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'karman-ui/src/utils/dom';
  import { isObject } from 'karman-ui/src/utils/types';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['kui-icon-star-on', 'kui-icon-star-on', 'kui-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'kui-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'kui-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'kui-rate__item')) {
            target = target.querySelector('.kui-rate__icon');
          }
          if (hasClass(target, 'kui-rate__decimal')) {
