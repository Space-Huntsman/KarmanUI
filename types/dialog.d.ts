...
export declare class KuiDialog extends KarmanUIComponent {
  /** Title of Dialog */
  title: string
  ...
  /** Whether to append modal to body karman. If false, the modal will be appended to Dialog's parent karman */
