...
export declare class KuiTableColumn extends KarmanUIComponent {
  ...
  /** Whether column width can be resized. Works when border of `kui-table` is `true` */
  resizable: boolean
  ...
  headerAlign: KarmanUIHorizontalAlignment
