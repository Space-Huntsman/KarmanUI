...
export declare class KuiMessageBoxComponent extends Vue {
  title: string
  message: string
  type: MessageType
  iconClass: string
...
export interface KuiMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: KuiMessageBoxComponent) => void

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: KuiMessageBoxComponent, done: (() => void)) => void
...
export interface KuiMessageBoxShortcutMethod {
  (message: string, title: string, options?: KuiMessageBoxOptions): Promise<MessageBoxData>
  (message: string, options?: KuiMessageBoxOptions): Promise<MessageBoxData>
}

export interface KuiMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: KuiMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: KuiMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: KuiMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: KuiMessageBoxShortcutMethod

  /** Set default options of message boxes */
  setDefaults (defaults: KuiMessageBoxOptions): void
