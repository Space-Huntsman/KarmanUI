...
/** The resizability of kui-input component */
export type Resizability = 'none' | 'both' | 'horizontal' | 'vertical'
export type InputType = 'text' | 'textarea'

/** Controls how kui-input component automatically sets size */
...
/** Input Component */
export declare class KuiInput extends KarmanUIComponent {
  /** Type of input */
  type: InputType
  ...
  /**
   * Select the text in input karman
   */
  select (): void
}
