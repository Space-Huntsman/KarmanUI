<template>
  <div :style="{
    ...
    <kui-dialog :visible.sync="copyDialogVisible" :modal-append-to-body="false">
      <kui-form :model="copyForm" ref="copyForm" :rules="copyFormRule">
        <kui-form-item label="主题名称" prop="name">
          <kui-input v-model="copyForm.name"></kui-input>
        </kui-form-item>
      </kui-form>
      <div slot="footer" class="dialog-footer">
        <kui-button @click="closeCopyForm">取消</kui-button>
        <kui-button type="primary" @click="copyToUser">确认</kui-button>
      </div>
    </kui-dialog>
  </div>
</template>
