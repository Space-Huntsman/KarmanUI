        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <kui-dropdown @command="actionClick">
                <i class="kui-icon-more"></i>
                <kui-dropdown-menu slot="dropdown">
                  <kui-dropdown-item command="rename">{{getActionDisplayName('rename-theme')}}</kui-dropdown-item>
                  <kui-dropdown-item command="copy">{{getActionDisplayName('copy-theme')}}</kui-dropdown-item>
                  <kui-dropdown-item
                      command="delete"
                      style="color: #F56C6C;"
                    >
...
import dateUtil from 'karman-ui/src/utils/date';
