<template>
  <kui-color-picker
    ...
    v-model="theme"></kui-color-picker>
</template>
...
<style lang="scss">
  ...
  .theme-picker .kui-color-picker__trigger {
    vertical-align: middle;
  }

  .theme-picker-dropdown .kui-color-dropdown__link-btn {
    display: none;
  }
</style>
  ...
  export default {
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/karman-ui@${ version }/lib/theme-default/index.css`;
