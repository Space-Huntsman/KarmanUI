        ...
        <li>
          <div class="card">
            ...
            <a
              ...
              href="https://github.com/KarmanUI/Resources/raw/master/Karman_Components_v2.1.0.rplib"
            ><%= 5 ></a>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <a
              ...
              href="https://github.com/KarmanUI/Resources/raw/master/Karman%20UI%20Kit_v2.0.sketch"
            ><%= 5 ></a>
          </div>
        </li>
        <!--<li>-->
          <!--<div class="card">-->
            ...
            <!--<h3><%= 8 ></h3>-->
            <!--<p><%= 9 ></p>-->
            <!--<a href="https://github.com/KarmanUI/Resources/raw/master/Karman%20Components%20Documentation.zip"><%= 5 ></a>-->
          <!--</div>-->
        <!--</li>-->
      </ul>
    </div>
