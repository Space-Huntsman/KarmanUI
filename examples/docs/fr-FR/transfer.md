...
<template>
  ...
  <div style="text-align: center">
    <kui-transfer
      ...
      @change="handleChange"
      :data="data">
      <kui-button class="transfer-footer" slot="left-footer" size="small">Opération</kui-button>
      <kui-button class="transfer-footer" slot="right-footer" size="small">Opération</kui-button>
    </kui-transfer>
