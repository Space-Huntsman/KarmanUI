...
<template>
  <kui-tabs v-model="activeName" @tab-click="handleClick">
    <kui-tab-pane label="User" name="first">Utilisateur</kui-tab-pane>
    <kui-tab-pane label="Config" name="second">Config</kui-tab-pane>
    <kui-tab-pane label="Role" name="third">Rôle</kui-tab-pane>
    <kui-tab-pane label="Task" name="fourth">Tâche</kui-tab-pane>
  </kui-tabs>
</template>
<script>
  export default {
...
<template>
  <kui-tabs type="card" @tab-click="handleClick">
    <kui-tab-pane label="User">Utilisateur</kui-tab-pane>
    <kui-tab-pane label="Config">Config</kui-tab-pane>
    <kui-tab-pane label="Role">Rôle</kui-tab-pane>
    <kui-tab-pane label="Task">Tâche</kui-tab-pane>
  </kui-tabs>
</template>
<script>
  export default {
...
<template>
  <kui-radio-group v-model="tabPosition" style="margin-bottom: 30px;">
    <kui-radio-button label="top">En haut</kui-radio-button>
    <kui-radio-button label="right">À droite</kui-radio-button>
    <kui-radio-button label="bottom">En bas</kui-radio-button>
    <kui-radio-button label="left">À gauche</kui-radio-button>
  </kui-radio-group>
