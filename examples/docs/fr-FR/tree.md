...
:::demo
```html
<kui-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></kui-tree>
...
<div class="buttons">
  <kui-button @click="getCheckedNodes">Récupération par noeud</kui-button>
  <kui-button @click="getCheckedKeys">Récupération par clé</kui-button>
  <kui-button @click="setCheckedNodes">Sélection par noeud</kui-button>
  <kui-button @click="setCheckedKeys">Sélection par clé</kui-button>
  <kui-button @click="resetChecked">Reset</kui-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <kui-button size="mini" type="text" on-click={ () => this.append(data) }>Ajouter</kui-button>
              <kui-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Supprimer</kui-button>
            </span>
          </span>);
      }
    }
