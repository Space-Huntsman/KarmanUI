...
<kui-upload
  ...
  :file-list="fileList">
  <kui-button size="small" type="primary">Cliquer pour envoyer</kui-button>
  <div slot="tip" class="kui-upload__tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</kui-upload>
<script>
  export default {
    data() {
...
<kui-upload
  ...
  <i v-else class="kui-icon-plus avatar-uploader-icon"></i>
</kui-upload>

<style>
  .avatar-uploader .kui-upload {
...
<kui-upload
  ...
  :on-remove="handleRemove">
  <i class="kui-icon-plus"></i>
</kui-upload>
<kui-dialog :visible.sync="dialogVisible">
...
<kui-upload
  ...
  list-type="picture-card"
  :auto-upload="false">
    <i slot="default" class="kui-icon-plus"></i>
    <div slot="file" slot-scope="{file}">
      <img
        class="kui-upload-list__item-thumbnail"
        :src="file.url" alt=""
      >
      <span class="kui-upload-list__item-actions">
        <span
...
<kui-upload
  ...
  :file-list="fileList"
  multiple>
  <i class="kui-icon-upload"></i>
  <div class="kui-upload__text">Déposer les fichiers ici ou<em>cliquez pour envoyer</em></div>
  <div class="kui-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</kui-upload>
```
:::
...
<kui-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <kui-button slot="trigger" size="small" type="primary">Choisir un fichier</kui-button>
  <kui-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">Envoyer au serveur</kui-button>
  <div class="kui-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</kui-upload>
<script>
  export default {
...
accept | [Types de fichiers](https://developer.mozilla.org/en-US/docs/Web/HTML/karman/input#attr-accept) acceptés, ne marche pas si `thumbnail-mode` est `true`. | string | — | —
