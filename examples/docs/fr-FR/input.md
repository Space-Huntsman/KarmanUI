...
```html
<kui-input placeholder="Entrez quelque chose" v-model="input"></kui-input>
...
```html
<kui-input placeholder="Entrez votre mot de passe" v-model="input" show-password></kui-input>
...
```html
<div>
  <kui-input placeholder="Entrez quelque chose" v-model="input1">
    <template slot="prepend">Http://</template>
  </kui-input>
</div>
<div style="margin-top: 15px;">
  <kui-input placeholder="Entrez quelque chose" v-model="input2">
    <template slot="append">.com</template>
  </kui-input>
</div>
<div style="margin-top: 15px;">
  <kui-input placeholder="Entrez quelque chose" v-model="input3" class="input-with-select">
    <kui-select v-model="select" slot="prepend" placeholder="Choisir">
      <kui-option label="Restaurant" value="1"></kui-option>
      <kui-option label="Num. Commande" value="2"></kui-option>
...
| ----| ----| ----| ---- | ----- |
| type| Type de l'input. | string | text, textarea et autres [types d'input natifs](https://developer.mozilla.org/en-US/docs/Web/HTML/karman/input#Form_%3Cinput%3E_types) | text |
