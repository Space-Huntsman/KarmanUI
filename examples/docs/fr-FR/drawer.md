...
|---------- |-------------- |---------- |--------------------------------  |-------- |
| append-to-body | Controls should Drawer be inserted to DocumentBody Karman, nested Drawer must assign this param to **true**| boolean   | — | false |
...
| modal-append-to-body | Indicates should shadowing layer be insert into DocumentBody karman | boolean   | — | true |
