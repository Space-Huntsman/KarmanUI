...
<template>
  <kui-popover
    ...
    <kui-button slot="reference">hover 激活</kui-button>
  </kui-popover>
  ...
  <kui-popover
    ...
    trigger="click"
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
    <kui-button slot="reference">click 激活</kui-button>
  </kui-popover>
  ...
  <kui-button v-popover:popover>focus 激活</kui-button>
  ...
  <kui-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
    v-model="visible">
    <kui-button slot="reference" @click="visible = !visible">手动激活</kui-button>
  </kui-popover>
</template>
...
<kui-popover
  ...
  <kui-table :data="gridData">
    <kui-table-column width="150" property="date" label="日期"></kui-table-column>
    <kui-table-column width="100" property="name" label="姓名"></kui-table-column>
    <kui-table-column width="300" property="address" label="地址"></kui-table-column>
  </kui-table>
  <kui-button slot="reference">click 激活</kui-button>
</kui-popover>
...
<kui-popover
  ...
  <div style="text-align: right; margin: 0">
    <kui-button size="mini" type="text" @click="visible = false">取消</kui-button>
    <kui-button type="primary" size="mini" @click="visible = false">确定</kui-button>
  </div>
