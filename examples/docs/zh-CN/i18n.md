...
Karman 组件内部默认使用中文，若希望使用其他语言，则需要进行多语言设置。以英文为例，在 main.js 中：
...
Karman 兼容 [vue-i18n@5.x](https://github.com/kazupon/vue-i18n)，搭配使用能更方便地实现多语言切换。
...
## 兼容其他 i18n 插件
如果不使用 `vue-i18n@5.x`，而是用其他的 i18n 插件，Karman 将无法兼容，但是可以自定义 Karman 的 i18n 的处理方法。
...
如果你需要使用其他的语言，欢迎贡献 PR：只需在 [这里](https://github.com/spaceHuntsman/karman/tree/dev/src/locale/lang) 添加一个语言配置文件即可。
