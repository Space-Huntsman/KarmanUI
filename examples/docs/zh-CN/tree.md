...
<div class="buttons">
  <kui-button @click="getCheckedNodes">通过 node 获取</kui-button>
  <kui-button @click="getCheckedKeys">通过 key 获取</kui-button>
  <kui-button @click="setCheckedNodes">通过 node 设置</kui-button>
  <kui-button @click="setCheckedKeys">通过 key 设置</kui-button>
  <kui-button @click="resetChecked">清空</kui-button>
</div>
