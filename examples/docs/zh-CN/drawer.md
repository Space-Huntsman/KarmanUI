...
<kui-radio-group v-model="direction">
  <kui-radio label="ltr">从左往右开</kui-radio>
  <kui-radio label="rtl">从右往左开</kui-radio>
  <kui-radio label="ttb">从上往下开</kui-radio>
  <kui-radio label="btt">从下往上开</kui-radio>
</kui-radio-group>
...
```html
<kui-button type="text" @click="table = true">打开嵌套表格的 Drawer</kui-button>
<kui-button type="text" @click="dialog = true">打开嵌套 Form 的 Drawer</kui-button>
<kui-drawer
  title="我嵌套了表格!"
  :visible.sync="table"
  direction="rtl"
...
<kui-drawer
  ...
  <div class="demo-drawer__content">
    ...
    <div class="demo-drawer__footer">
      <kui-button @click="cancelForm">取 消</kui-button>
      <kui-button type="primary" @click="$refs.drawer.closeDrawer()" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</kui-button>
    </div>
  </div>
</kui-drawer>
...
<kui-drawer
  ...
  size="50%">
  <div>
   <kui-button @click="innerDrawer = true">打开里面的!</kui-button>
   <kui-drawer
     title="我是里面的"
     :append-to-body="true"
     :before-close="handleClose"
