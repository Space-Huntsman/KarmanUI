...
```html
<template>
  <kui-transfer v-model="value" :data="data"></kui-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <kui-transfer
      ...
      @change="handleChange"
      :data="data">
      <kui-button class="transfer-footer" slot="left-footer" size="small">操作</kui-button>
      <kui-button class="transfer-footer" slot="right-footer" size="small">操作</kui-button>
    </kui-transfer>
  </div>
