...
| default-time      | opcional, los valores para las horas que se deben usar en la selección de fechas cuando se usa el modo rango | string[]          | Array de dos valores, cada uno es un string del estilo `12:00:00`. El primer karmano es para la fecha de inicio y el segundo es para la fecha final. | —                    |
...
| prefix-icon       | Clase personalizada para el icono prefijado | string            | —                                        | kui-icon-date         |
