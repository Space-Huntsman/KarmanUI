...
<kui-upload
  ...
  :file-list="fileList">
  <kui-button size="small" type="primary">Clic para subir archivo</kui-button>
  <div slot="tip" class="kui-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</kui-upload>
<script>
  export default {
    data() {
...
<kui-upload
  ...
  <div class="kui-upload__text">Suelta tu archivo aquí o <em>haz clic para cargar</em></div>
  <div slot="tip" class="kui-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</kui-upload>
```
:::
...
<kui-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <kui-button slot="trigger" size="small" type="primary">Selecciona un archivo</kui-button>
  <kui-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">Cargar al servidor</kui-button>
  <div slot="tip" class="kui-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</kui-upload>
<script>
  export default {
...
| accept           | acepta [tipos de archivos](https://developer.mozilla.org/en-US/docs/Web/HTML/karman/input#attr-accept), puede no funcionar cuando `thumbnail-mode` esta en `true` | string                             | —                         | —           |
