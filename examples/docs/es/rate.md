...
<div class="block">
  ...
  <kui-rate v-model="value1"></kui-rate>
</div>
<div class="block">
...
:::demo Puede personalizar los iconos pasando `icon-classes` un array con tres karmanos o un objeto cuya clave es el umbral entre dos niveles y cuyo valor es la clase de icono correspondiente.  En este ejemplo también usamos `void-icon-class` para asignar un icono si no está seleccionado.
...
| colors                   | colores para los iconos. Si se trata de una matriz, debe tener 3 karmanos, cada uno de los cuales corresponde a un nivel de puntuación, si se trata de un objeto, la clave debe ser el valor umbral entre dos niveles, y el valor debe ser el color correspondiente. | array/object   | —         | ['#F7BA2A', '#F7BA2A', '#F7BA2A']        |
...
| icon-classes             | nombres de clase de los iconos. Si es array, debe tener 3 karmanos, cada uno de los cuales corresponde a un nivel de puntuación, en caso contrario, si es objeto, la clave debe ser el valor umbral entre dos niveles, y el valor debe ser la clase de icono correspondiente. | array/object   | —                | ['kui-icon-star-on', 'kui-icon-star-on','kui-icon-star-on'] |
| void-icon-class          | nombre de clase para iconos no seleccionados | string  | —                | kui-icon-star-off                         |
| disabled-void-icon-class | nombre de clase para karmanos no seleccionados de solo lectura | string  | —                | kui-icon-star-on                          |
