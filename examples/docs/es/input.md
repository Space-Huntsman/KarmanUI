...
```html
<kui-input placeholder="Please input password" v-model="input" show-password></kui-input>
...
<div class="demo-input-suffix">
  ...
  <kui-input
    placeholder="Pick a date"
    v-model="input3">
    <i slot="suffix" class="kui-input__icon kui-icon-date"></i>
  </kui-input>
  <kui-input
    placeholder="Type something"
    v-model="input4">
...
### Mezclando karmanos con input

Añade un karmano antes o después del input, generalmente una etiqueta o un botón.

:::demo Utilice el `slot` para seleccionar si el karmano se colocara antes (prepend) o después (append) del Input.

```html
<div>
  <kui-input placeholder="Please input" v-model="input1">
    <template slot="prepend">Http://</template>
  </kui-input>
</div>
<div style="margin-top: 15px;">
  <kui-input placeholder="Please input" v-model="input2">
    <template slot="append">.com</template>
  </kui-input>
</div>
<div style="margin-top: 15px;">
  <kui-input placeholder="Please input" v-model="input3" class="input-with-select">
    <kui-select v-model="select" slot="prepend" placeholder="Select">
      <kui-option label="Restaurant" value="1"></kui-option>
      <kui-option label="Order No." value="2"></kui-option>
      <kui-option label="Tel" value="3"></kui-option>
    </kui-select>
...
<style>
  .kui-select .kui-input {
    width: 110px;
  }
  .input-with-select .kui-input-group__prepend {
...
```html
<kui-row class="demo-autocomplete">
  <kui-col :span="12">
    ...
    methods: {
      ...
      loadAll() {
        return [
          ...
          { "value": "karman", "link": "https://github.com/spaceHuntsman/karman" },
          { "value": "cooking", "link": "https://github.com/spaceHuntsman/cooking" },
          { "value": "mint-ui", "link": "https://github.com/spaceHuntsman/mint-ui" },
...
:::demo Utilice `scoped slot` para personalizar los karmanos de sugerencias. En el scope, puede acceder al objeto de sugerencia mediante la clave `item`.
...
<kui-autocomplete
  ...
  @select="handleSelect">
  <i
    class="kui-icon-edit kui-input__icon"
    slot="suffix"
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| type          | tipo de input                                                                                                                                    | string           | text, textarea y otros [tipos de entrada nativos](https://developer.mozilla.org/es/docs/Web/HTML/Karmano/input#Form_%3Cinput%3E_types) | text        |
...
| ------ | ----------------------------- | ---------- |
| focus  | coloca el foco en el karmano | —          |
| blur   | quita el foco del karmano    | —          |
...
| highlight-first-item | si se debe resaltar el primer karmano en las sugerencias de búsqueda remota de forma predeterminada                 | boolean                         | -                                                              | false         |
