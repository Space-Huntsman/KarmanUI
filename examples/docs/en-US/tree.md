...
<div class="buttons">
  <kui-button @click="getCheckedNodes">get by node</kui-button>
  <kui-button @click="getCheckedKeys">get by key</kui-button>
  <kui-button @click="setCheckedNodes">set by node</kui-button>
  <kui-button @click="setCheckedKeys">set by key</kui-button>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <kui-button size="mini" type="text" on-click={ () => this.append(data) }>Append</kui-button>
              <kui-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</kui-button>
            </span>
          </span>);
      }
    }
