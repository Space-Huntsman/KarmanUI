...
Prepend or append an karman, generally a label or a button.
...
| ----| ----| ----| ---- | ----- |
|type| type of input | string | text, textarea and other [native input types](https://developer.mozilla.org/en-US/docs/Web/HTML/karman/input#Form_%3Cinput%3E_types) | text |
...
|------|--------|-------|
| focus | focus the input karman | — |
| blur | blur the input karman | — |
