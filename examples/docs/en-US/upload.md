...
<kui-upload
  ...
  :file-list="fileList">
  <kui-button size="small" type="primary">Click to upload</kui-button>
  <div slot="tip" class="kui-upload__tip">jpg/png files with a size less than 500kb</div>
</kui-upload>
<script>
  export default {
    data() {
...
<kui-upload
  ...
  <div class="kui-upload__text">Drop file here or <em>click to upload</em></div>
  <div class="kui-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</kui-upload>
```
:::
...
<kui-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <kui-button slot="trigger" size="small" type="primary">select file</kui-button>
  <kui-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">upload to server</kui-button>
  <div class="kui-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</kui-upload>
<script>
  export default {
...
accept | accepted [file types](https://developer.mozilla.org/en-US/docs/Web/HTML/karman/input#attr-accept), will not work when `thumbnail-mode` is `true` | string | — | —
