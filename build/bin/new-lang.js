...
let componentNew = Object.assign({}, componentFile.filter(item => item.lang === 'zh-CN')[0], { lang });
...
let pageNew = Object.assign({}, pageFile.filter(item => item.lang === 'zh-CN')[0], { lang });
