...
export default ${ComponentName};`
  },
  {
    ...
    content: `<template>
  <div class="kui-${componentname}"></div>
</template>
...
`
  ...
  {
    filename: path.join('../../theme/default/src', `${componentname}.scss`),
...
// 添加到 index.scss
const sassPath = path.join(__dirname, '../../theme/default/src/index.scss');
...
// 添加到 karman-ui.d.ts
const karmanTsPath = path.join(__dirname, '../../types/karman-ui.d.ts');
...
fileSave(karmanTsPath)
  .write(karmanTsText, 'utf8')
  .end('\n');
