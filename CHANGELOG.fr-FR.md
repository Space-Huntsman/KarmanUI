...
- Input
  - Correction du style de show-word-count dans kui-form (#15359 by @lvjiaxuan)
...
- Switch
  - Label avec les événements récurrents kui-switch (#15178 by @FAKER-A)
- Slider
...
- Form
  - Correction du style de `labkui-width` auto (#14955 par @ziyoung)
...
- Form
  - `labkui-width` supporte la largeur automatique (#14944 by @ziyoung)
...
- NavMenu
  - Correction d'un bug de clic sur kui-submenu (#14443 par @PanJiaChen)
- Dropdown
...
- DropdownItem
  - Ajout de la propriété `icon` à `kui-dropdown-item` (par @gabrielboliveira dans #14088)
- Input
...
- Menu
  - Ajout du support de `kui-menu-item` sans index (par @georgyfarniev dans #13298)
- Table
...
- Build
  - Minification du CSS et du JS pour le site d'Karman (par @iamkun dans #14430)
...
- Maintenant `class-name` et `labkui-class-name` de Table sont réactifs, #11626
...
- MessageBox
  - Correction de la classe `kui-popup-parent-hidden` qui n'était pas supprimée à l'ouverture successive de MessageBox, #11371
...
- La directive Loading prend maintenant en charge le nom de classe personnalisé grâce à l'attribut `karman-loading-custom-class`, #8826 (par @earlymeme)
...
#### Nouvelles fonctionnalités
- Général
  - Un nouveau thème : `theme-default`.
